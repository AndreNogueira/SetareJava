    ...
    <fieldset class="fieldset-border">
        ...
        <div class="row">
            <div class="large-6 columns">
                ...
                <s:textfield name="first_name" placeholder="Insert your first name..." required="true" pattern="alpha" />
                <small class="error">You need to insert your first name.</small>
            </div>
            <div class="large-6 columns">
                <s:label value="Last Name" />
                <s:textfield name="last_name" placeholder="Insert your last name..." required="true" pattern="alpha" />
        ...
        <div class="row">
            <div class="large-6 columns">
                ...
                <s:select name="card_type" list="creditCards" headerKey="-1" headerValue="Choose your card type" required="true" />
                <small class="error">You need to choose your credit card type.</small>
            </div>
            <div class="large-6 columns">
                <s:label value="Credit Card Number" />
                <s:textfield name="card_number" placeholder="Insert your credit card number..." required="true" pattern="number" />
